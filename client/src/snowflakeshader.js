...
export class Snowflake_Shader extends Particle_Shader {
    ...
    vertex_glsl_code() {
        ...
        return this.shared_glsl_code() + `
                ...
                void main(){                                                                   
                    ...
                    // Maybe use normal vector to simulate wind? 
    ...
    send_material(gl, gpu, material, program) {
        ...
        if(material.hasOwnProperty('localTime')) {
            ...
            // console.log("[FLAKE SHADER] Snowflake's previous GPU localTime: " + gl.getUniform(program, gpu.localTime));
            // console.log("[FLAKE SHADER] Snowflake's material localTime is " + material.localTime);
            gl.uniform1f(gpu.localTime, material.localTime);
            // console.log("[FLAKE SHADER] Snowflake's GPU localTime: " + gl.getUniform(program, gpu.localTime));
