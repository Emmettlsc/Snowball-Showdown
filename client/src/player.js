...
export class Player {
    ...
    constructor(playerID, moveSpeed, fireRate, fireSpeed) {
        ...
        this.fireSpeed = fireSpeed; // A vec3 consisting of *scalars* for x, y, and z (since the initial throwing direction is based on which way the player is facing, which the Player class has no idea of)
